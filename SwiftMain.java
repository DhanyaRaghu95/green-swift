...
public class SwiftMain {
	...
	public static double SSDPowerConsumption()
	{
		return ProxyServer.ssdPower*ProxyServer.timeSSDUsed;  // power per sec = 3
	}

	public static double nodePowerConsumption()
	{
		return ProxyServer.nodePower*ProxyServer.timeNodeUsed;  // power per sec = 3
	}
